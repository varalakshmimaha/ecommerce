...
<div class="container mx-auto px-4 py-12">
    <div class="max-w-md mx-auto bg-white p-6 rounded shadow">
        ...
        <p class="text-sm text-gray-600 mt-4">Don't have an account? <a href="<?php echo e(route('user.register')); ?>" class="text-primary-600">Register</a></p>
    </div>
</div>
...
<?php echo $__env->make('layouts.frontend', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/vikasverma/Projects/suvee/resources/views/frontend/auth/login.blade.php ENDPATH**/ ?>