...
<div class="relative h-96 md:h-[500px] overflow-hidden">
    <div id="banner-slider" class="h-full">
        ...
        <div class="banner-slide absolute inset-0 opacity-0 transition-opacity duration-1000">
            <img src="<?php echo e(asset('storage/' . $banner->image)); ?>" alt="<?php echo e($banner->title); ?>" class="w-full h-full object-cover">
            <?php if($banner->title || $banner->description): ?>
            <div class="absolute inset-0 bg-black bg-opacity-30 flex items-center justify-center">
                <div class="text-center text-white px-4 animate-slide-up">
                    <?php if($banner->title): ?>
                    <h2 class="text-4xl md:text-6xl font-bold mb-4"><?php echo e($banner->title); ?></h2>
                    <?php endif; ?>
                    <?php if($banner->description): ?>
                    <p class="text-xl md:text-2xl"><?php echo e($banner->description); ?></p>
                    <?php endif; ?>
                    <?php if($banner->link): ?>
                    <a href="<?php echo e($banner->link); ?>" class="bg-gradient-to-r from-[#D4AF37] to-[#B8962E] text-white px-6 py-3 rounded-lg font-semibold hover:shadow-lg transform hover:-translate-y-0.5 transition-all duration-300 mt-6 inline-block">Shop Now</a>
                    <?php endif; ?>
                </div>
            </div>
            <?php endif; ?>
    ...
    <div class="absolute bottom-4 left-1/2 transform -translate-x-1/2 flex space-x-2">
        ...
        <button class="banner-dot w-3 h-3 rounded-full bg-white <?php echo e($index === 0 ? 'opacity-100' : 'opacity-50'); ?>" data-slide="<?php echo e($index); ?>"></button>
        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
    </div>
</div>
<?php endif; ?>
...
<section class="container mx-auto px-4 py-12 bg-white">
    ...
    <div class="text-center mt-8">
        <a href="<?php echo e(route('products.index')); ?>" class="bg-gradient-to-r from-[#D4AF37] to-[#B8962E] text-white px-6 py-3 rounded-lg font-semibold hover:shadow-lg transform hover:-translate-y-0.5 transition-all duration-300">View All Products</a>
    </div>
</section>
...
<a href="https://wa.me/919845145363?text=Hi%20I%20am%20interested%20in%20your%20products"
   ...
   target="_blank">
    <!--<img src="<?php echo e(asset('build/assets/whatsapp.png')); ?>" alt="WhatsApp">-->
...
<?php echo $__env->make('layouts.frontend', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/bestprime-ecommerce/htdocs/ecommerce.bestprime.live/suvee/resources/views/frontend/home.blade.php ENDPATH**/ ?>