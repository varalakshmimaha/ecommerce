    ...
    <form action="<?php echo e(route('admin.products.update', $product)); ?>" method="POST" enctype="multipart/form-data" class="space-y-6">
        ...
        <div class="border-t pt-6">
            <div class="flex justify-between items-center mb-4">
                ...
                <a href="<?php echo e(route('admin.product-attributes.create')); ?>?product_id=<?php echo e($product->id); ?>" class="text-sm text-[#D4AF37] hover:text-[#D4AF37]">
                ...
                <div class="space-y-2 mb-4">
                    <?php $__currentLoopData = $product->attributes; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $attr): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <div class="flex items-center justify-between p-3 bg-gray-50 rounded">
                            ...
                            <form action="<?php echo e(route('admin.product-attributes.destroy', $attr)); ?>" method="POST" class="inline" onsubmit="return confirm('Delete this attribute?')">
                                <?php echo csrf_field(); ?>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/bestprime-ecommerce/htdocs/ecommerce.bestprime.live/suvee/resources/views/admin/products/edit.blade.php ENDPATH**/ ?>