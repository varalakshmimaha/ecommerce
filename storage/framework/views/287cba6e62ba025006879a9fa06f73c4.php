...
<div class="grid grid-cols-1 lg:grid-cols-2 gap-4 md:gap-6">
    <div class="admin-card">
        ...
        <div class="space-y-4">
            ...
            <div id="banner-<?php echo e($banner->id); ?>" class="border rounded-lg p-4" 
                 data-title="<?php echo e(e($banner->title)); ?>"
                 data-description="<?php echo e(e($banner->description)); ?>"
                 data-link="<?php echo e(e($banner->link)); ?>"
                 data-sort_order="<?php echo e($banner->sort_order); ?>"
                 data-is_active="<?php echo e($banner->is_active); ?>"
            >
                <img src="<?php echo e(asset('storage/' . $banner->image)); ?>" alt="<?php echo e($banner->title); ?>" class="w-full h-48 object-cover rounded-lg mb-2">
                <div class="flex items-center justify-between">
                    <div>
                        <h3 class="font-semibold"><?php echo e($banner->title ?? 'No Title'); ?></h3>
                        <p class="text-sm text-gray-500"><?php echo e($banner->is_active ? 'Active' : 'Inactive'); ?></p>
                    </div>
                    <div class="flex space-x-2">
                        <button onclick="editBanner(<?php echo e($banner->id); ?>)" class="text-[#D4AF37]">Edit</button>
                        <form action="<?php echo e(route('admin.banners.destroy', $banner)); ?>" method="POST" class="inline" onsubmit="return confirm('Are you sure?')">
                            <?php echo csrf_field(); ?>
    ...
    <div class="admin-card">
        ...
        <form action="<?php echo e(route('admin.banners.store')); ?>" method="POST" enctype="multipart/form-data" class="space-y-4">
            <?php echo csrf_field(); ?>
            <div>
...
<script>
    const adminBannersBase = "<?php echo e(url('admin/banners')); ?>";
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/bestprime-ecommerce/htdocs/ecommerce.bestprime.live/suvee/resources/views/admin/banners/index.blade.php ENDPATH**/ ?>