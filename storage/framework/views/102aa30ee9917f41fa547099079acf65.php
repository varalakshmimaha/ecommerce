            ...
            <div class="grid grid-cols-2 gap-8 mb-8">
                ...
                <div class="bg-gradient-to-br from-gray-50 to-white p-6 rounded-lg border border-gray-200">
                    ...
                    <div class="text-gray-700 space-y-1">
                        <p class="font-semibold text-gray-900"><?php echo e($order->user->name ?? $order->name); ?></p>
                        <p class="text-sm"><?php echo e($order->user->mobile ?? $order->mobile); ?></p>
                        <?php if($order->user->email ?? $order->email): ?>
                            <p class="text-sm"><?php echo e($order->user->email ?? $order->email); ?></p>
                        <?php endif; ?>
                    </div>
                    <div class="text-gray-700 space-y-1 text-sm">
                        <p><?php echo e($order->addresses->address ?? $order->address); ?></p>
                        <p><?php echo e($order->addresses->city ?? ''); ?>, <?php echo e($order->addresses->state ?? ''); ?></p>
                        <p><?php echo e($order->addresses->pincode ?? $order->pincode); ?></p>
                    </div>
                </div>
            </div>
...
</html><?php /**PATH /Users/vikasverma/Projects/suwish/resources/views/invoices/order.blade.php ENDPATH**/ ?>