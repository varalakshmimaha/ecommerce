            ...
            <div>
                ...
                <div class="space-y-2 text-sm">
                    ...
                    <p><span class="font-medium">Payment Method:</span> 
                        <span class="px-2 py-1 text-xs font-semibold rounded-full <?php echo e($order->payment_method === 'razorpay' ? 'bg-blue-100 text-blue-800' : ($order->payment_method === 'cod' ? 'bg-green-100 text-green-800' : 'bg-purple-100 text-purple-800')); ?>">
                            <?php echo e(ucfirst($order->payment_method)); ?>

                        </span>
                    </p>
                    <?php if($order->razorpay_payment_id): ?>
                    <p><span class="font-medium">Razorpay Payment ID:</span> <?php echo e($order->razorpay_payment_id); ?></p>
                    <?php endif; ?>
            ...
            <div class="overflow-x-auto">
                <table class="admin-table">
                    ...
                    <tbody>
                        ...
                        <tr>
                            <td>
                              <img src="<?php echo e(asset('storage/' . $item->product->main_image)); ?>" alt="<?php echo e($item->name); ?>" class="w-16 h-16 object-cover rounded-lg">
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/bestprime-ecommerce/htdocs/ecommerce.bestprime.live/suvee/resources/views/admin/orders/show.blade.php ENDPATH**/ ?>