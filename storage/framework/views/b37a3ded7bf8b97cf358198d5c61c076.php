        ...
        <aside class="bg-gradient-to-b from-white to-gray-50 border-r border-gray-100 shadow-lg w-full md:w-64 md:flex-shrink-0 overflow-y-auto hidden md:flex md:flex-col" id="adminSidebar">
            <div class="p-6 flex-1">
                ...
                <nav class="space-y-2">
                    ...
                    <a href="<?php echo e(route('admin.payment.index')); ?>" class="flex items-center px-4 py-3 text-[#1A1A1A] rounded-lg hover:bg-gradient-to-r hover:from-[#D4AF37] hover:to-[#B8962E] hover:text-white transition-all duration-300 <?php echo e(request()->routeIs('admin.payment.*') ? 'bg-gradient-to-r from-[#D4AF37] to-[#B8962E] text-white shadow-md' : ''); ?>">
                        <svg class="w-5 h-5 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
...
<?php /**PATH /home/bestprime-ecommerce/htdocs/ecommerce.bestprime.live/suvee/resources/views/layouts/admin.blade.php ENDPATH**/ ?>