                ...
                >
                    <div class="flex items-center justify-between mb-2">
                        ...
                        <div class="flex space-x-2">
                            <button type="button" onclick="editCategory(<?php echo e($category->id); ?>)" class="text-[#D4AF37] text-sm">Edit</button>
                    ...
                    <div class="ml-4 mt-3 space-y-2 border-l-2 border-gray-300 pl-4">
                        ...
                        >
                            ...
                            <div class="flex space-x-1">
                                <button type="button" onclick="editSubCategory(<?php echo e($category->id); ?>, <?php echo e($subcat->id); ?>)" class="text-[#D4AF37] text-xs">Edit</button>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/bestprime-ecommerce/htdocs/ecommerce.bestprime.live/suvee/resources/views/admin/categories/index.blade.php ENDPATH**/ ?>