...
<div class="space-y-6">
    <div class="admin-card">
        ...
        <form action="<?php echo e(route('admin.payment.update')); ?>" method="POST" class="space-y-6">
            <?php echo csrf_field(); ?>
                    ...
                    <div class="flex items-center space-x-2">
                        <label class="flex items-center cursor-pointer">
                            <input type="checkbox" 
                                   ...
                                   value="1" 
                                   <?php echo e(old('payment_methods.manual.is_active', $paymentSettings->where('payment_method', 'manual')->first()?->is_active ?? true) ? 'checked' : ''); ?>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div>
                        ...
                        <input type="number" 
                               ...
                               value="<?php echo e(old('payment_methods.manual.sort_order', $paymentSettings->where('payment_method', 'manual')->first()?->sort_order ?? 1)); ?>" 
                               min="0" 
                               class="input-field">
                    </div>
                </div>
                    ...
                    <div class="flex items-center space-x-2">
                        <label class="flex items-center cursor-pointer">
                            <input type="checkbox" 
                                   ...
                                   value="1" 
                                   <?php echo e(old('payment_methods.cod.is_active', $paymentSettings->where('payment_method', 'cod')->first()?->is_active ?? false) ? 'checked' : ''); ?>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div>
                        ...
                        <input type="number" 
                               ...
                               value="<?php echo e(old('payment_methods.cod.sort_order', $paymentSettings->where('payment_method', 'cod')->first()?->sort_order ?? 2)); ?>" 
                               min="0" 
                               class="input-field">
                    </div>
                </div>
                    ...
                    <div class="flex items-center space-x-2">
                        <label class="flex items-center cursor-pointer">
                            <input type="checkbox" 
                                   ...
                                   value="1" 
                                   <?php echo e(old('payment_methods.razorpay.is_active', $paymentSettings->where('payment_method', 'razorpay')->first()?->is_active ?? false) ? 'checked' : ''); ?>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div>
                        ...
                        <input type="text" 
                               ...
                               value="<?php echo e(old('razorpay_key_id', $paymentSettings->where('payment_method', 'razorpay')->first()?->settings['key_id'] ?? '')); ?>" 
                    ...
                    <div>
                        ...
                        <input type="password" 
                               ...
                               value="<?php echo e(old('razorpay_key_secret', $paymentSettings->where('payment_method', 'razorpay')->first()?->settings['key_secret'] ?? '')); ?>" 
                    ...
                    <div>
                        ...
                        <input type="number" 
                               ...
                               value="<?php echo e(old('payment_methods.razorpay.sort_order', $paymentSettings->where('payment_method', 'razorpay')->first()?->sort_order ?? 3)); ?>" 
                               min="0" 
                               class="input-field">
                    </div>
                </div>
...
function testRazorpayConnection() {
    ...
    fetch('<?php echo e(route("admin.payment.test-razorpay")); ?>')
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/bestprime-ecommerce/htdocs/ecommerce.bestprime.live/suvee/resources/views/admin/payment/index.blade.php ENDPATH**/ ?>