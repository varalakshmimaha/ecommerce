    ...
    <footer class="bg-gradient-to-b from-white to-gray-50 border-t border-gray-100 text-[#1A1A1A] mt-16">
        <div class="container mx-auto px-4 py-12">
            ...
            <div class="border-t border-gray-200 mt-8 pt-8 text-center text-[#6B6B6B] text-sm">
                <p>&copy; <?php echo e(date('Y')); ?> Suwish. All rights reserved.</p>
            </div>
        </div>
    </footer>
...
<?php /**PATH /home/thesuwishclothing/htdocs/thesuwishclothing.com/suwish/resources/views/layouts/frontend.blade.php ENDPATH**/ ?>