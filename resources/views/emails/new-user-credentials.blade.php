...
<body>
    ...
    <div class="content">
        ...
        <p>Thank you for placing your order <strong>#{{ $orderNumber }}</strong>. We've created an account for you to track your orders and enjoy a better shopping experience.</p>
        ...
        <center>
            <a href="{{ url('/user/login') }}" class="button">Login to Your Account</a>
        </center>
