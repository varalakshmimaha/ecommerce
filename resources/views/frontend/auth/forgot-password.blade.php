    ...
    <div class="max-w-md w-full animate-fade-in">
        <div class="bg-white rounded-2xl shadow-xl overflow-hidden">
            ...
            <div class="text-center pt-8 pb-6 px-8">
                ...
                <h2 class="text-3xl font-bold text-text-heading">Forgot Password</h2>
                <p class="text-text-muted mt-2">Enter your email to reset your password</p>
            </div>
            ...
            <div class="px-8 pb-8">
                ...
                <form method="POST" action="{{ route('password.email') }}" class="space-y-5">
                    @csrf
                    <div class="space-y-2">
                        <label class="block text-sm font-semibold text-text-heading">Email Address *</label>
                        <div class="relative">
