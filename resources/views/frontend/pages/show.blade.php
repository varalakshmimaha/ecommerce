            ...
            <div class="bg-white rounded-2xl shadow-2xl border border-gray-100 overflow-hidden animate-fade-in">
                ...
                <div class="p-8">
                    ...
                    <div class="mt-12 pt-6 border-t border-gray-100">
                        <a href="{{ route('home') }}" class="inline-flex items-center gap-2 bg-gradient-to-r from-[#D4AF37] to-[#B8962E] text-white px-8 py-3 rounded-lg font-semibold hover:shadow-lg hover:shadow-[#D4AF37]/50 transition-all duration-300 transform hover:scale-105">
