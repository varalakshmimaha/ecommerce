...
<div class="space-y-6">
    <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
        <a href="{{ route('admin.reports.product-sales') }}" class="admin-card hover:shadow-xl transition-all duration-300 transform hover:-translate-y-1">
        ...
        <a href="{{ route('admin.reports.order-sales') }}" class="admin-card hover:shadow-xl transition-all duration-300 transform hover:-translate-y-1">
            <div class="text-center">
        ...
        <a href="{{ route('admin.reports.overall-sales') }}" class="admin-card hover:shadow-xl transition-all duration-300 transform hover:-translate-y-1">
            <div class="text-center">
