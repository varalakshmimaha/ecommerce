        ...
        <form action="{{ route('admin.pages.update', $page) }}" method="POST" id="pageForm" class="space-y-6">
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                ...
                <div class="flex items-end">
                    <label class="flex items-center space-x-2 cursor-pointer">
                        ...
                        <input type="checkbox" name="show_in_navbar" value="1" {{ old('show_in_navbar', $page->show_in_navbar) ? 'checked' : '' }} class="w-5 h-5 rounded border-gray-300 text-[#D4AF37] focus:ring-[#D4AF37] accent-[#D4AF37]">
                ...
                <div class="flex items-end">
                    <label class="flex items-center space-x-2 cursor-pointer">
                        ...
                        <input type="checkbox" name="show_in_footer" value="1" {{ old('show_in_footer', $page->show_in_footer) ? 'checked' : '' }} class="w-5 h-5 rounded border-gray-300 text-[#D4AF37] focus:ring-[#D4AF37] accent-[#D4AF37]">
            ...
            <div class="flex items-center p-4 bg-gradient-to-r from-amber-50 to-yellow-50 border border-amber-200 rounded-lg">
                <label class="flex items-center space-x-3 cursor-pointer">
                    ...
                    <input type="checkbox" name="is_active" value="1" {{ old('is_active', $page->is_active) ? 'checked' : '' }} class="w-5 h-5 rounded border-gray-300 text-[#D4AF37] focus:ring-[#D4AF37] accent-[#D4AF37]">
