                ...
                >
                    <div class="flex items-center justify-between mb-2">
                        ...
                        <div class="flex space-x-2">
                            <button type="button" onclick="editCategory({{ $category->id }})" class="text-primary-600 text-sm">Edit</button>
                    ...
                    <div class="ml-4 mt-3 space-y-2 border-l-2 border-gray-300 pl-4">
                        ...
                        >
                            ...
                            <div class="flex space-x-1">
                                <button type="button" onclick="editSubCategory({{ $category->id }}, {{ $subcat->id }})" class="text-primary-600 text-xs">Edit</button>
