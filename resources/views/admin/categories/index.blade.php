                ...
                >
                    <div class="flex items-center justify-between mb-2">
                        ...
                        <div class="flex space-x-2">
                            <button type="button" onclick="editCategory({{ $category->id }})" class="text-brand-gold text-sm">Edit</button>
                    ...
                    <div class="ml-4 mt-3 space-y-2 border-l-2 border-gray-300 pl-4">
                        ...
                        >
                            ...
                            <div class="flex space-x-1">
                                <button type="button" onclick="editSubCategory({{ $category->id }}, {{ $subcat->id }})" class="text-brand-gold text-xs">Edit</button>
    ...
    <div class="space-y-6">
        ...
        <div class="admin-card">
            ...
            <form action="{{ route('admin.categories.store') }}" method="POST" enctype="multipart/form-data" class="space-y-3">
                ...
                <button type="submit" class="bg-gradient-to-r from-brand-gold via-brand-amber to-brand-crimson text-white px-6 py-3 rounded-lg font-semibold hover:shadow-lg transform hover:-translate-y-0.5 transition-all duration-300 w-full text-sm py-2">Add Category</button>
            </form>
        </div>
        ...
        <div class="admin-card">
            ...
            <form id="addSubcategoryForm" action="{{ route('admin.sub-categories.store') }}" method="POST" enctype="multipart/form-data" class="space-y-3">
                ...
                <button type="submit" class="bg-gradient-to-r from-brand-gold via-brand-amber to-brand-crimson text-white px-6 py-3 rounded-lg font-semibold hover:shadow-lg transform hover:-translate-y-0.5 transition-all duration-300 w-full text-sm py-2">Add Sub-Category</button>
            </form>
        </div>
    </div>
</div>
