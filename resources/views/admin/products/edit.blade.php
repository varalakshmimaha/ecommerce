        ...
        <div class="flex items-center justify-between mb-4">
            ...
            <div class="flex gap-2">
                <a href="{{ route('admin.products.variations.index', $product) }}" 
                   class="bg-brand-gold text-white px-4 py-2 rounded-lg text-sm font-medium hover:bg-brand-amber transition-all duration-300">
                ...
                <a href="{{ route('admin.products.variations.create', $product) }}" 
                   class="bg-gradient-to-r from-brand-gold via-brand-amber to-brand-crimson text-white px-4 py-2 rounded-lg text-sm font-medium hover:shadow-lg transition-all duration-300">
                    <svg class="w-4 h-4 inline mr-1" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        ...
                        <div class="flex items-center gap-3">
                            ...
                            <div>
                                ...
                                <div class="text-sm text-gray-600">
                                    ...
                                    @else
                                        Base Price: ₹{{ number_format($product->final_price, 2) }}
                                    @endif
        ...
        @else
            <div class="text-center py-8">
                <div class="text-gray-500">
                    ...
                    <p class="text-gray-500 mb-4">Create product variations to manage different sizes, colors, and other options.</p>
                    <a href="{{ route('admin.products.variations.create', $product) }}" 
