...
<div class="admin-card max-w-4xl">
    ...
    <form action="{{ route('admin.products.store') }}" method="POST" enctype="multipart/form-data" class="space-y-6" id="product-form">
        ...
        <div>
            ...
            <p class="text-xs text-gray-500 mt-1">Select multiple images for gallery</p>
        </div>
        ...
        <div class="border-t pt-6">
            ...
            <input type="hidden" name="related_products" id="related_products" value="">
            ...
            <div id="attributes-container" class="space-y-4">
                <div class="attribute-row grid grid-cols-1 md:grid-cols-4 gap-4 p-4 bg-gray-50 rounded-lg">
                    ...
                    <div class="flex items-end space-x-2">
                        <input type="number" name="attributes[0][stock_adjustment]" value="0" class="input-field" placeholder="Stock Adj">
        ...
        <div class="flex justify-end space-x-4 pt-6 border-t">
            ...
            <button type="submit" class="bg-gradient-to-r from-brand-gold via-brand-amber to-brand-crimson text-white px-6 py-3 rounded-lg font-semibold hover:shadow-lg transform hover:-translate-y-0.5 transition-all duration-300">Create Product</button>
        </div>
    </form>
</div>
...
<script>
    ...
    function addAttributeRow() {
        ...
        newRow.innerHTML = `
            ...
            <div class="flex items-end space-x-2">
                <input type="number" name="attributes[${attributeIndex}][stock_adjustment]" value="0" class="input-field" placeholder="Stock Adj">
                <button type="button" onclick="this.closest('.attribute-row').remove()" class="text-red-600 hover:text-red-700 font-medium px-2">×</button>
            </div>
        `;
...
<style>
    ...
    /* Animation for modal */
    #related-products-modal .relative {
    ...
    button[onclick="openRelatedProductsModal()"] {
        box-shadow: 0 4px 6px -1px rgba(212, 175, 55, 0.1), 0 2px 4px -1px rgba(212, 175, 55, 0.06);
    }
    
    button[onclick="openRelatedProductsModal()"]:hover {
