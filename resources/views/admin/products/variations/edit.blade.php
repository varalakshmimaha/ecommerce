        ...
        <form method="POST" action="{{ route('admin.products.variations.update', [$product, $variation]) }}" enctype="multipart/form-data" class="space-y-6">
            ...
            <div>
                <h3 class="text-lg font-semibold text-text-heading mb-4 flex items-center gap-2">
                    ...
                    Variation Attributes
                    <span class="text-sm text-gray-500 font-normal">(Select one or multiple values for each attribute)</span>
                </h3>
                        ...
                        @foreach($attributes as $attribute)
                            <div class="border border-gray-200 rounded-lg p-4">
                                ...
                                @if($attribute->activeValues->count() > 0)
                                    ...
                                    <p class="mt-2 text-xs text-gray-500">Select one or multiple {{ $attribute->name }} options</p>
                                @else
